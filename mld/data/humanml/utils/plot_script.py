...
# plt.rcParams['animation.ffmpeg_path'] = '/nfs/miniconda3/envs/pt0/bin/ffmpeg'
...
def plot_3d_motion(save_path, kinematic_tree, joints, title, figsize=(10, 10), fps=120, radius=3):
    # 将radius改小可以放大动作占比！！
    matplotlib.use('Agg')
